...
1. Clone 本项目
   ...
   ```sh
   git clone https://github.com/CaoMeiYouRen/cz-conventional-changelog-cmyr.git
   ```
...
你在源代码中发现了一个错误，文档中有一个错误，或者你想要一个新功能？ 看看[GitHub 讨论](https://github.com/CaoMeiYouRen/cz-conventional-changelog-cmyr/discussions)看看它是否已经在讨论中。您可以通过[在 GitHub 上提交问题](https://github.com/CaoMeiYouRen/cz-conventional-changelog-cmyr/issues)来帮助我们。在创建问题之前，请确保搜索问题存档 - 您的问题可能已经得到解决！
...
1. 在我们的存储库中搜索 与您的提交相关的开放或关闭的 [Pull Requests](https://github.com/CaoMeiYouRen/cz-conventional-changelog-cmyr/pulls)。你不想重复努力。
...
6. [打开一个新的 Pull Request](https://github.com/CaoMeiYouRen/cz-conventional-changelog-cmyr/compare?expand=1)
